...
* [Coding](coding/README.md)
  ...
  * [Use abi.encodeCall() for Low-Level Calls](coding/abi-encodecall.md)
...
* [Ongoing Upgrades](upgrades/README.md)
  * [Handling Communications Before a Smart Contract Upgrade](upgrades/handling-comms-upgrade.md)
  * [Ensure Changes Are Backwards Compatible](upgrades/upgrade-backwards-compatibillity.md)
  * [Use Existing Unit Tests to Prevent Regression Bugs](upgrades/prevent-regression-bugs.md)
  * [Handling State Migration in a Secure Way](upgrades/handling-migrations.md)
  * [Key Considerations for the Security Review of Upgrades](upgrades/key-considerations-upgrade-reviews.md)

* [Ongoing Operations](operations/README.md)
  * [Establish a Chief of Security Role](operations/chief-of-security.md)
  * [Establish a Security Council](operations/security-council.md)
  * [Managing Privileged Accounts Securely](operations/securing-privileged-accounts.md)
  * [Add Regression Tests After Fixing Vulnerabilities](operations/regression-tests-for-vulns.md)
